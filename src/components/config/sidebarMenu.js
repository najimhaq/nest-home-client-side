...
export const sidebarMenu = {
  ...
  ADMIN: [
    { label: 'Overview', href: '/dashboard/admin', icon: FiLayout },
    { label: 'All Users', href: '/dashboard/admin/users', icon: FiUsers },
    { label: 'All Properties', href: '/dashboard/admin/properties', icon: FiHome },
    { label: 'All Bookings', href: '/dashboard/admin/bookings', icon: FiCalendar },
